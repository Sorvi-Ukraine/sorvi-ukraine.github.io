...
<html>
    <head>
        <title>Добро пожаловать на <? print $host; ?>! Hostinger хостинг с MySQL и PHP.</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://hostinger.com.ua/"><img src="http://www.main-hosting.com/hostinger/welcome/images/logo.png" alt="Хостинг" /></a>
                </div>
                <div class="content">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://hostinger.com.ua/hosting" target="_blank">Веб-Хостинг</a> 
                    <span class="pipe">|</span> 
                    <a href="http://hostinger.com.ua/besplatnui-hosting" target="_blank">Бесплатный Хостинг</a> 
                    <span class="pipe">|</span> 
                    <a href="http://hostinger.com.ua/forum" target="_blank">Форум Поддержки</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.com.ua/" target="_blank">Вход для клиентов</a>
                </div>
                <div class="copyright">Hostinger Украина &copy; <? print date('Y'); ?>. Все права защищены.</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.com.ua"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
                    <a href="http://twitter.com/HostingerUA"><img src="http://www.main-hosting.com/hostinger/welcome/images/twitter.gif" /></a>
                </div>
            </div>
        </div>
    </body>
